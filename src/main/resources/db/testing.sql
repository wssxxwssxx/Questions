...
INSERT INTO t_question (q_id, form_id, qname) VALUES (1100, 3000, 'Как звали бабулю?');
...
--Вопрос: сначала узнай номер ид_формы чтоб задать его в следующий запрос
INSERT INTO t_question (q_id, form_id, qname) VALUES (1101, 3000, 'Кто убил бабулю?');
--Ответы: сначала узнай номер ид_вопроса чтоб задать его в след. запросе
...
--Вопрос: сначала узнай номер ид_формы чтоб задать его в следующий запрос
INSERT INTO t_question (q_id, form_id, qname) VALUES (1102, 3000, 'Назовите орудие убийства?');
--Ответы: сначала узнай номер ид_вопроса чтоб задать его в след. запросе
